    ...
    <div class="container">
        ...
        <div class="col-md-1 col-sm-6">
            <div class="product-item">
                <h5><a href="SearchEssayByCategory?Category=<%=Constant.keywords.get(i).getKeyword()%>&page=1"><%=Constant.keywords.get(i).getKeyword()%></a></h5>
            </div> <!-- /.product-item -->
        </div> <!-- /.col-md-3 -->
            ...
            <div class="panel panel-default">
                <div class="panel-group" id="accordion">
                    ...
                    <div >
                        ...
                        %>
                        <p>
                            <a <%if (Constant.EssayCurrentPage>1){%> href=<%=url+"1"%><%}%>>首页</a>
                            <!-- 上页按钮，跳转到上一页 -->
                            <a <%if (Constant.EssayCurrentPage>1){%> href=<%=url+(Constant.EssayCurrentPage-1)%><%}%>>上页</a>

                            <!-- 下页按钮，跳转到下一页 -->
                            <a <%if (Constant.EssayCurrentPage<Constant.EssayTotalpage){%> href=<%=url+(Constant.EssayCurrentPage+1)%><%}%>>下页</a>

                            <!-- 末页按钮，跳转到最后一页 -->
                            <a <%if (Constant.EssayCurrentPage<Constant.EssayTotalpage){%> href=<%=url+Constant.EssayTotalpage%><%}%>>末页</a>
